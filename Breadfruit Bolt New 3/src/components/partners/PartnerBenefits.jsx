...
function PartnerBenefits() {
  const benefits = [
    {
      ...
      description: "Reach new customers through our digital marketplace",
      icon: (
    ...
    },
    {
      ...
      description: "Reduce costs with our efficient digital platform",
      icon: (
        <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Tap into the growing digital insurance market",
      icon: (
        <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: "Update prices and products in real-time",
      icon: (
        <svg className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <div className="py-24 bg-gradient-to-b from-gray-50 via-white to-gray-50 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Everything you need to succeed in the digital insurance market
          </p>
        </motion.div>
